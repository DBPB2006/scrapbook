...
const uploadDir = process.env.UPLOAD_DIR || (process.env.STORAGE_PATH ? path.join(process.env.STORAGE_PATH, 'Uploads', 'friends') : path.join(__dirname, 'uploads/friends/'));
